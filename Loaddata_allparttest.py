...
def load_sampledata():
    ...
    img = np.load("./Sampledata/xpsamplepet.npy") #Deeplearningallpatchsmalls
    datapet = np.asarray(img,dtype="float32")
    img = np.load("./Sampledata/xpsamplect.npy") #Deeplearningallpatchsmalls
    datact = np.asarray(img,dtype="float32")
    img = np.load("./Sampledata/xpsamplefuse.npy") #Deeplearningallpatchsmalls
    datafuse = np.asarray(img,dtype="float32")
    y = np.load("./Sampledata/label.npy")
